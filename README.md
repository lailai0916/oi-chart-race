...
├── tools/                          # Cards and post-production scripts
...
This project's code is licensed under [AGPL-3.0-or-later](LICENSE). It imports modules from the upstream `OIerDb-ng/OIerDb-data-generator`, which uses AGPL-3.0, at runtime.
